...
const date = global.db.data.users[m.sender].juegos + 600000; //21600000 = 1 hs 
if (new Date - global.db.data.users[m.sender].juegos < 600000) throw `『⏰』𝙀𝙨𝙥𝙚𝙧𝙖 : ${msToTime(date - new Date())} 𝙥𝙖𝙧𝙖 𝙫𝙤𝙡𝙫𝙚𝙧 𝙖 𝙟𝙪𝙜𝙖𝙧 `
